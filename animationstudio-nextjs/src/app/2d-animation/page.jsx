...
// Media
import GridImg1 from "media/2d-animation-page/grid/1.png"
import GridImg2 from "media/2d-animation-page/grid/2.png"
import GridImg3 from "media/2d-animation-page/grid/3.png"
import GridImg4 from "media/2d-animation-page/grid/4.png"
import GridImg5 from "media/2d-animation-page/grid/5.png"
        ...
        <>
            ...
            <FAQs items={[
                ...
                },
                {
                    ...
                    content: "<p>2D animation simplifies the complex. By combining visual storytelling with clear explanations, we transform highly anticipated ideas into engaging content. Our animations combine the power of motion graphics, graphic design, and character animation to create mind blowing and informative videos.</p>"
                },
                {
                    title: "Why is 2d animation service good?",
                    content: "<p>2D animation offers unmatched efficiency, affordability and versatility. It's the ideal choice for businesses who are looking for impactful video content that delivers results.</p>"
                }
            ]} />
            <Footer />
        </>
