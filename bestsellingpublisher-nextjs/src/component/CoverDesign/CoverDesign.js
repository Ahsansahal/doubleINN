                        ...
                        <div className="col-md  hover:-translate-y-1 hover:scale-105 duration-300 hover:text-black">
                            <div className="rounded-2xl p-2 hover:bg-white bg-transparent text-center text-[#1d1d1f] hover:text-[#000] h-[100%] border-2 border-solid">
                                ...
                                <div className='p-2'>
                                    ...
                                    <p className='text-sm'>
                                        Our team at Best Selling Publisher is among the best in developing concepts. We work closely with authors to understand their book’s theme, genre, and essence. From this foundation, we develop unique and captivating concepts for the book cover that resonate with the story’s core. This eventually leads to our creative designers working on making an ideal cover that fits the book’s theme.
                                    </p>
