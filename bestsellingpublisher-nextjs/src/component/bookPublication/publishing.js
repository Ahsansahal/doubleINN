                        ...
                        <div className='basis-[50%] md:basis-[60%]'>
                            <div className=' xs:py-5'>
                                ...
                                <p className='xs:w-[100%]'>
                                    We are a premium ghostwriting services company founded to provide excellent writing services. At Best Selling Publisher, we take a customer-centric approach to assist you in establishing yourself as a professional writer by providing high-quality content copies, guaranteeing outstanding results and a massive online reach.
                                </p>
                            </div>
                        </div>
