                        ...
                        <div className='basis-[60%] md:basis-[100%]'>
                            <div className=' xs:py-5'>
                                ...
                                <p className='xs:w-[90%] w-[90%] mb-5'>
                                    Our experienced ghostwriters and publishing experts are here to guide you through the entire process of getting your book published. At Best Selling Publisher, we understand that publishing a book is a journey. We offer a comprehensive range of services to ensure your book receives the attention and care it deserves:
                                </p>
