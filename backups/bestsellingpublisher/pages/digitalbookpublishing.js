...
const digitalbookpublishing = () => {
    const newSpan = <h1 className='font-50 fw-700 font-primary txt-secondary mt-3'>Digital Book Publishing <br /> Services To Help You Get <br /> Your Book Into The Hands <br /> Of Interested Readers!</h1>;
  ...
  export default digitalbookpublishing
