  ...
  return (
    <section>
      <div className="container">
        <div>
          <AutoScrollSlider arrows="false" wrapperClasses="my-5" direction="forward">
            {[partner1, partner2, partner3, partner4, partner5, partner6, partner7, partner8].map((img, i) => (
              <div key={i} className="grow-0 group shrink-0 lg:basis-auto basis-[30%] min-w-0 pl-8">
                <div className="relative">
                  ...
                  <Image tabIndex={0} key={i} src={img} alt="SEO company" className="rounded-[10px]" quality={95} width={200} height={100} />
                </div>
              </div>
            ))}
          </AutoScrollSlider>
